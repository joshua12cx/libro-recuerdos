...
// ============================================================================
// 📸 CÓMO COLOCAR TUS PROPIAS IMÁGENES:
// ============================================================================
// Tienes 2 opciones para agregar tus fotos:
//
// OPCIÓN 1 - IMÁGENES EN LÍNEA (URLs de internet):
// Si tus fotos están en internet (Google Photos, Dropbox, Drive, etc.):
// 1. Obtén el enlace directo de la imagen
// 2. Reemplaza la URL en el campo "image:" de cada recuerdo
// Ejemplo: image: "https://mi-enlace-de-foto.com/foto1.jpg"
//
// OPCIÓN 2 - IMÁGENES LOCALES (desde tu computadora):
// Si quieres usar fotos de tu computadora:
// 1. Crea una carpeta llamada "images" dentro de /src/app/
// 2. Coloca tus fotos ahí (ejemplo: foto1.jpg, foto2.jpg, etc.)
// 3. Al inicio del archivo, importa tus imágenes así:
//    import foto1 from "../images/foto1.jpg";
//    import foto2 from "../images/foto2.jpg";
// 4. Luego usa el nombre de la variable en el campo "image:"
//    Ejemplo: image: foto1
//
// ============================================================================
...
const memories: Memory[] = [
  {
    ...
    image: "https://images.unsplash.com/photo-1658851866325-49fb8b7fbcb2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxyb21hbnRpYyUyMGNvdXBsZSUyMHN1bnNldHxlbnwxfHx8fDE3NzMxNTg5NDF8MA&ixlib=rb-4.1.0&q=80&w=1080", // 👈 CAMBIA ESTA URL POR TU IMAGEN
    layout: "single"
  },
  {
    id: 2,
    ...
    image: "https://images.unsplash.com/photo-1506014299253-3725319c0f69?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb3VwbGUlMjBob2xkaW5nJTIwaGFuZHN8ZW58MXx8fHwxNzczMjExODAyfDA&ixlib=rb-4.1.0&q=80&w=1080", // 👈 CAMBIA ESTA URL POR TU IMAGEN
    layout: "single"
  },
  {
    id: 3,
    ...
    image: "https://images.unsplash.com/photo-1614680889829-9b2d25a71be0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxyb21hbnRpYyUyMGRpbm5lciUyMGNhbmRsZXN8ZW58MXx8fHwxNzczMTUyNDEwfDA&ixlib=rb-4.1.0&q=80&w=1080", // 👈 CAMBIA ESTA URL POR TU IMAGEN
    layout: "single"
  },
  {
    id: 4,
    ...
    image: "https://images.unsplash.com/photo-1719559981587-040e4614b4dc?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb3VwbGUlMjBiZWFjaCUyMHdhbGtpbmd8ZW58MXx8fHwxNzczMTQzNjk3fDA&ixlib=rb-4.1.0&q=80&w=1080", // 👈 CAMBIA ESTA URL POR TU IMAGEN
    layout: "single"
  },
  {
    id: 5,
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1766717419809-954c4e4d0885?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb3VwbGUlMjBsYXVnaGluZyUyMHRvZ2V0aGVyfGVufDF8fHx8MTc3MzE1NjY2OXww&ixlib=rb-4.1.0&q=80&w=1080", // 👈 CAMBIA ESTA URL POR TU IMAGEN
    layout: "single"
  },
  {
    id: 7,
    ...
    image: "https://images.unsplash.com/photo-1768466588502-029946e98a75?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxyb21hbnRpYyUyMHBpY25pYyUyMHBhcmt8ZW58MXx8fHwxNzczMjQ5MzUxfDA&ixlib=rb-4.1.0&q=80&w=1080", // 👈 CAMBIA ESTA URL POR TU IMAGEN
    layout: "single"
  },
  {
    id: 8,
    ...
    image: "https://images.unsplash.com/photo-1489924482931-41c82360d29d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb3VwbGUlMjBjaXR5JTIwbmlnaHR8ZW58MXx8fHwxNzczMjQ5MzUxfDA&ixlib=rb-4.1.0&q=80&w=1080", // 👈 CAMBIA ESTA URL POR TU IMAGEN
    layout: "single"
  }
  // 💡 CONSEJO: Puedes agregar más recuerdos copiando un bloque completo
  // y pegándolo aquí con id: 9, id: 10, etc.
];
